...
public class MainActivity extends Activity {
    ...
    {    
    	btnTT.setOnClickListener((android.view.View.OnClickListener) new ProcessMyEvent());     
    	btnTiep.setOnClickListener((android.view.View.OnClickListener) new ProcessMyEvent());     
    	btnTK.setOnClickListener((android.view.View.OnClickListener) new ProcessMyEvent());    	
    	btnThoat.setOnClickListener((android.view.View.OnClickListener) new ProcessMyEvent());    
    }
